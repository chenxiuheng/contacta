/* $Id: AccountAction.java 669 2010-07-22 21:38:16Z michele.bianchi $
 *
...
import mic.organic.json.AccountJson;
...
@Scope("request")
public class AccountAction extends AbstractAaaSmd<AccountJson, AccountModel>
{
  static private Logger logger; @SuppressWarnings("static-access")
  protected Logger log()  { if (this.logger == null) this.logger = LoggerFactory.getLogger(this.getClass()); return this.logger; }

  @Autowired private AaaGateway aaaGateway;//AccountDao cocDao;
  ...
  @SMDMethod
  @Override
  public AccountJson persist(AccountJson json) throws JsonException
  {
    try
    {
      return aaaGateway.accountPersist(json);
    }
    catch (Exception e)
    {
  ...
  public Boolean[] remove(int[] ids) throws JsonException
  {
    try
    {
      return aaaGateway.accountRemove(ids);
    }
    catch (Exception e)
    {
  ...
  @SMDMethod
  @Override
  public AccountJson find(int id)
  {
    return aaaGateway.accountFind(id);
  }
  ...
  @SMDMethod
  @Override
  public DatastoreJson<AccountJson> findAll()
  {
    List<AccountJson> jsonList = aaaGateway.accountList();
    DatastoreJson<AccountJson> store = new DefaultDatastoreJson<AccountJson>(jsonList);
    return store;
  }
  ...
  {
    return accountService.findAccount(oid);
  }
