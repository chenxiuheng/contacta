...
<div class="bg00" style="width:340px;">
 <div class="organicBg" style="height:28px; padding:1px 4px;">
  <div style="float:right; padding:2px 0px 1px 0px; color:white; font-size:9px;">${m.t("title.version")}</div>
 ...
 <div class="" style="margin-left:auto; margin-right:auto; width:180px; height:160px;">
  <div style="padding-bottom:30px;">
   <div style="margin-left:auto; margin-right:auto; margin-top:.2em; margin-bottom:.2em; width:8em; font-weight:bold; color:#f89b33;"><#--${m.t("title.login")}--><br/></div>
