/* $Id: ImportServiceTest.java 663 2010-07-18 18:46:56Z michele.bianchi $
 *
...
public class ImportServiceTest extends AbstractProvisioningTests
{
  ...
  public void testImportFromCsv() throws OrganicException
  {
    ...
    assertEquals(addressbookService.findPersonList().size(), 0);
    assertEquals(addressbookService.findAllOrganizations().size(), 0);
  }
